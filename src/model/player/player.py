...
class Player(IPlayer):
    ...
    def __init__(self, initial_health: int = 100,
        ...
        self.__player_impl = PlayerImplementation(initial_health, initial_position, base_attack_power)
...
class PlayerImplementation:
    ...
    def __init__(self, initial_health: int, initial_position: Position, base_attack_power: int):
