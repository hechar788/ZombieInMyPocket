...
from src.model.turn.turn_enums import Triggers, ServiceNames, ServicesMethods, StateNames
...
class MyTestCase(unittest.TestCase):
    ...
    def create_mock_state(self, name, result=None, trigger=None):
        ...
        def handle_enter_side_effect(*args, **kwargs):
            ...
            mock_state.context.call_service_method(ServiceNames.GAME_PIECES, ServicesMethods.GET_TILE_DOORS)
